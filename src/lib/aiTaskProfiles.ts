...
export const AI_TASK_PROFILES: Record<AiTaskTier, AiTaskProfile> = {
  ...
  grounded: { tier: 'grounded', model: 'gemini-3.7-flash', capability: 'search', thinkingLevel: 'low', tools: ['googleSearch'], timeoutMs: 90_000, fallbacks: ['gemini-3.6-flash', 'gemini-3.5-flash-lite', 'groq/compound-mini', 'groq/compound'] },
